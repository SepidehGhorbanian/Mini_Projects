...
@author: UNISEPP
"""
# We have data about NBA Basketball players and games
# We want to analyze the data and visualize some factors
...
# example : how much was Dwight Howard's salary in 2006?
# print(Salary[Pdict['DwightHoward'],Sdict['2006']])
# print(Salary[4][1])
...
# examle : how many games Carmelo Anthony played in 2012?
...
#Matrix
freethrowsattempt = np.array([KobeBryant_FTA , JoeJohnson_FTA , LeBronJames_FTA , CarmeloAnthony_FTA , DwightHoward_FTA , ChrisBosh_FTA , ChrisPaul_FTA , KevinDurant_FTA , DerrickRose_FTA , DwayneWade_FTA])

# Creating a plot function
def myplot(data , playerlist = Players):
    
    Col = {'KobeBryant':'black','JoeJohnson':'blue','LeBronJames':'red' ,'CarmeloAnthony':'magenta' ,'DwightHoward':'black','ChrisBosh':'blue','ChrisPaul':'red','KevinDurant':'magenta','DerrickRose':'green','DwayneWade':'green'} 
    ...
    for name in playerlist:
        plt.plot(data[Pdict[name]] , C = Col[name] , Marker = Mrk[name] , ls = '--' , label = name)
